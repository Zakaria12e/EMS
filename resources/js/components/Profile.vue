...
const formData = ref({
  fullName: 'Elbidali zakaria',
  phoneNumber: '+212 xxxx xxx xxx',
  emailAddress: 'zakariael1211@gmail.com',
  username: 'zaki456',
  appKey: 'xxxxxxx',
})
        ...
        <div class="p-7">
          <form @submit.prevent="handleSubmit">
            ...
            <div class="flex justify-end gap-4.5">
              ...
              <button
                class="flex justify-center rounded bg-primary py-2 px-6 bg-blue-600 font-medium text-white hover:bg-opacity-90"
                type="submit"
              >
                Save
              </button>
        ...
        <div class="p-7">
          <form @submit.prevent="handlePhotoSubmit">
            ...
            <div class="flex justify-end gap-4.5">
              ...
              <button
                class="flex justify-center rounded bg-blue-600 py-2 px-6 font-medium text-white hover:bg-opacity-90"
                type="submit"
              >
                Save
              </button>
